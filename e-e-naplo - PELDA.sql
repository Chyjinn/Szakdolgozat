...
--
-- Gép: 127.0.0.1:3306
-- Létrehozás ideje: 2020. Már 16. 13:32
...
--
-- A tábla adatainak kiíratása `epitkezesek`
--

INSERT INTO `epitkezesek` (`id`, `megn`, `telepules`, `iranyitoszam`, `cim`, `hatarido`) VALUES
(1, 'Példa', 'Vác', 2600, 'Kossuth tér 1.', '2020-03-16');
...
--
-- A tábla adatainak kiíratása `epitkezes_jogok`
--

INSERT INTO `epitkezes_jogok` (`id`, `epit_id`, `felh_id`, `jog_id`) VALUES
(1, 1, 1, 4);
